...
applicantCourseRouter.post(
  "/me/course-checkout",
  auth(UserRole.APPLICANT),
  validateRequest(courseValidation.checkoutCourseSchema),
  courseController.applicantCheckout,
);

//======== List my course purchases =========
applicantCourseRouter.get(
  "/me/course-purchases",
  auth(UserRole.APPLICANT),
  courseController.applicantMyPurchases,
);

//======== Download receipt PDF =========
applicantCourseRouter.get(
  "/me/course-purchases/:purchaseId/receipt",
  auth(UserRole.APPLICANT),
  courseController.applicantReceiptPdf,
);
