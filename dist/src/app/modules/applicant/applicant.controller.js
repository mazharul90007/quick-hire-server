...
import { PROFILE_IMAGE_FOLDER, assertPdfMagic, profileMultipartFiles, } from "../../helpers/profileMultipart";
...
const updateMyProfile = catchAsync(async (req, res) => {
    ...
    const result = await applicantServices.updateMyProfile(req.user.id, body, urls);
    sendResponse(res, {
        statusCode: status.OK,
        success: true,
