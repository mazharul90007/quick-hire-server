...
router.get("/me", auth(UserRole.RECRUITER), recruiterController.getMyProfile);
//==========Update Recruiter Profile=========
router.patch("/me", auth(UserRole.RECRUITER), uploadProfileAssets, parseOptionalMultipartJson, validateRequest(recruiterValidation.updateMyProfileSchema), recruiterController.updateMyProfile);
